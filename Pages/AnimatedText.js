  ...
  return (
    <ScrollView style={{flex: 1}} behavior="height">
      ...
      <View>
        <Image
          source={{
            uri: 'https://images.unsplash.com/photo-1606220838315-056192d5e927?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8fA%3D%3D&w=1000&q=80',
          }}
          style={{
            width: '100%',
            height: scale(320),
      ...
      <View style={{alignItems: 'center', justifyContent: 'center'}}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            if (countScale.value == 0) {
              countScale.value = 1;
              animatedX.value = withTiming(145, {duration: 1500});
              animatedY.value = withTiming(-630, {duration: 1500});
